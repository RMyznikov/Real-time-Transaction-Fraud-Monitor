...
- 1200 валідних транзакцій із сумою нижче fraud-ліміту;
- 100 невалідних транзакцій із нульовою сумою;
- 100 fraud-транзакцій із сумою від fraud-ліміту.
...
Команда збирає application image і запускає PostgreSQL, Kafka, init-сервіси, три workers і три consumers.
